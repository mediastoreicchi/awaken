...
This wordpress theme requires the Redux Framework Plugin.
When activating the theme it will ask to download and activate the redux framework plugin. 
Or you can manually download that plugin by visiting the https://wordpress.org/plugins/redux-framework/
